...
Las tuplas en Python son un tipo de datos **_inmutable_** que se utilizan para almacenar una colección de elementos ordenados. Las tuplas se definen usando paréntesis y los elementos se separan por comas.
